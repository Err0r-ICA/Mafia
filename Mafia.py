...
logo = """
    ...
    \033[1;94m::▒▒▒▒▒▒█▒▒▒█▒█▒█▒▒▒█▒█▒▒▒▒▒▒▒▒▒▒::::      
   \033[1;95m:::▒▒▒▒▒▒███▒███▒███▒███▒▒▒▒▒▒▒▒▒▒:::::         
  \033[1;96m::♧♧♧♧♧♧♧♧♧♧\033[1;91mErr0r\033[1;96m♧♧♧♧♧♧♧♧♧♧▒▒▒▒▒▒▒::::        
  \033[1;91m:》》》\033[1;93mItalia Cyber Army\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-Mafia-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................Mafia......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Italy
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
...
print  """ \033[48;5;0;38;5;219m
 ...
 'hC;9F`.`.`.`.`.`.;;;;;;F.`.$9?;h;;$F  ?.                 ".     "?$'
  ?h;P.`.`.`.`.`.`.;;;;;j'.`3;;???;;$?L  ?.                  "c     $
   ...
   \033[1;97m███████▒▒\033[48;5;0;38;5;202m Welcome To Mafia \033[1;97m▒▒████████

\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mMafia\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94m         Author\033[1;91m    : \033[1;94m                  Err0r
\033[1;92m         Mafia\033[1;91m     : \033[1;92m              ▒▓██████████████]99.9
\033[1;97m         Instagram\033[1;91m : \033[1;97m                  @termux_hacking
\033[1;91m         Team\033[1;91m      : \033[1;91m                  Italia Cyber Army
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mMafia\033[1;95m♡╰──────────•◈•──────────╯♡"""
print ""
jalan('\033[48;5;0;38;5;197m....................Mafia.....................:')
print "\n"
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin Mafia\033[1;95m♡╰──────•◈•──────╯♡ \n\n"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print ""
            print "Logged in Successfully as " + username #Dev:ERR0R
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://www.instagram.com/termux_hacking')
    else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mMafia\033[1;95m♡──────────•◈•──────────♡"
...
def menu():
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mMafia\033[1;95m♡──────────•◈•──────────♡"
	print "\033[1;97m--\033[1;92m> \033[1;92m01.\x1b[1;92mStart Cloning..."
	print "\033[1;97m--\033[1;91m> \033[1;91m00.\033[1;91mExit            "
	pilih()
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;96m--\033[1;92m> \033[1;92m01.\x1b[1;96mClone From Friend List..."
	print "\033[1;96m--\033[1;92m> \033[1;92m02.\x1b[1;92mClone From Public ID..."
	print "\033[1;96m--\033[1;91m> \033[1;91m00.\033[1;91mBack"
	pilih_super()
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mMafia\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By Italia Cyber Army---•◈•---»" #Dev:love_hacker
	...
	print """
        ...
        ...........███ ]▄▄▄▄▄▃
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Err0r ~ Mafia........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                Instagram :
